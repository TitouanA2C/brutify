          ...
          return (
            ...
            >
              ...
              >
                ...
                <p className="font-display text-3xl tracking-wider text-brutify-text-primary leading-none">
          ...
          >
            ...
            {isLoading ? (
              <div className="flex items-center justify-center py-8">
                <Loader2 className="h-6 w-6 animate-spin text-brutify-text-muted" />
              </div>
            ) : (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                {networks.map((network, i) => (
                  <motion.div
                    ...
                    className="rounded-xl border border-white/[0.08] bg-[#0c0c14]/80 p-4 hover:border-brutify-gold/20 hover:bg-[#0c0c14] transition-all duration-300"
                  >
                    <div className="flex items-center gap-2 mb-4">
                      <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-brutify-gold/[0.1] text-brutify-gold">
                        {platformIcons[network.platform] ?? <Activity className="h-3.5 w-3.5" />}
                      </div>
                      <span className="text-sm font-body font-semibold text-brutify-text-primary">
                        @{network.handle}
                      </span>
                    </div>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-baseline justify-between">
                        ...
                        <span className="font-display text-xl tracking-wider text-brutify-text-primary">
                      ...
                      <div className="flex items-baseline justify-between">
                        ...
                        <span className="font-display text-lg tracking-wider text-brutify-gold">
                      ...
                      {network.growth_rate > 0 && (
                        <div className="flex items-center gap-1.5 pt-1 border-t border-white/[0.04]">
                          <TrendingUp className="h-3 w-3 text-brutify-success" />
            ...
            {isLoading ? (
              ...
              <div className="space-y-2.5">
                {topOutliers.map((video, index) => (
                  ...
                  >
                    <Link
                      href={`/videos?highlight=${video.id}`}
            ...
            {isLoading ? (
              ...
              <div className="space-y-2.5">
                {trendingCreators.map((creator, index) => (
                  ...
                  >
                    <Link
                      href={`/creators?highlight=${creator.id}`}
                ...
                {upcomingBoard.map((item, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex items-center justify-between rounded-lg border border-white/[0.06] bg-brutify-elevated/20 px-4 py-3 transition-all duration-200 hover:border-white/[0.1] hover:bg-brutify-elevated/40"
                    >
